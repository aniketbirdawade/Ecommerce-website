...
public class Coupon 
{
    ...
    public Coupon(int id, String code, String discount_type, BigDecimal discount_value, BigDecimal min_order_amount,
    ...
    public String toString() {
        return "Coupon [id=" + id + ", code=" + code + ", discount_type=" + discount_type + ", discount_value="
