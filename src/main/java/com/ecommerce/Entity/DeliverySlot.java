...
public class DeliverySlot {
    ...
    public DeliverySlot(int id, Date date, Time start_time, Time end_time, int max_order, int avaliable_order) {
        super();
        this.id = id;
        this.date = date;
    ...
    public String toString() {
        return "DeliverySlot [id=" + id + ", date=" + date + ", start_time=" + start_time + ", end_time=" + end_time
